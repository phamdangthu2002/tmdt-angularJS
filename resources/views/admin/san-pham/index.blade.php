    ...
    <div class="container mt-5">
        ...
        <form ng-controller="ctrlProduct" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="price_sale" ng-model="product.price_sale" name="price_sale">
            </div>
            <!-- Mô tả -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="quantity_in_stock" ng-model="product.quantity_in_stock"
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="category" name="category_id" ng-model="product.category_id">
                    ...
                    <option ng-repeat="danhmuc in danhMuc" value="@{{ danhmuc.id }}">@{{ danhmuc.name }}</option>
                </select>
            </div>
