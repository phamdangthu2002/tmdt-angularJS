                        ...
                        <table class="table table-bordered" ng-if="categories.length > 0">
                            ...
                            <tbody>
                                <tr ng-repeat="category in categories">
                                    ...
                                    <td>
                                        <span ng-if="category.trangthai === 'active'" class="badge text-success">Kích
                                            hoạt</span>
                                        <span ng-if="category.trangthai === 'inactive'"
                                            class="badge text-danger">Khóa</span>
                                    </td>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <form ng-submit="updateDanhmuc()">
                                ...
                                <button type="submit" class="btn btn-primary" ng-click="update()">Cập Nhật Danh
                                    Mục</button>
